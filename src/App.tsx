          ...
          <div className={shell}>
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_240px] gap-0">
                ...
                {/* Counter original preservado — pode voltar
                ...
                */}
                <div className="hidden lg:flex" style={{ position: 'relative', zIndex: 1, alignItems: 'center', justifyContent: 'center', padding: '24px', minWidth: '280px' }}>
                  <video
                    src="/selo-eap.mp4"
                    autoPlay
                    loop
