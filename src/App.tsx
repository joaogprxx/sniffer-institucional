  ...
  return (
    ...
    >
      ...
      <nav style={{
        ...
        <div className={shell} style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px' }}>
          <a href="#top" style={{ display: 'flex', alignItems: 'center', gap: '8px', textDecoration: 'none', flexShrink: 0 }}>
            <img src="/mascote-colorido.png" alt="Sniffer" style={{ height: '52px', width: 'auto' }} />
            <img src="/MARCA%20SNIFFER%20-%20ROTA%20PULSANTE%20-%20RGB.png" alt="Sniffer" style={{ height: '28px', width: 'auto', maxWidth: '160px', objectFit: 'contain' }} />
          </a>
      ...
      <footer style={{ background: navy, color: 'rgba(255,255,255,0.45)', fontSize: '14px' }}>
        ...
        {/* Colunas de links */}
        <div className={shell} style={{ padding: '40px 0 36px' }}>
