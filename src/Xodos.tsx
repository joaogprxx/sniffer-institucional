...
export default function Xodos() {
  ...
  return (
    ...
    >
      {/* Background SVG texture (similar to Business page) */}
      <img
      ...
      <main 
        className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 mt-12 lg:mt-20 flex flex-col lg:flex-row gap-12 lg:gap-24"
      >
        {/* Left Column - Content */}
