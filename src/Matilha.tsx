          ...
          <div className="flex flex-col lg:flex-row gap-16 items-start mb-12">
            <div className="flex-1">
              <p className="text-lg lg:text-[19px] text-white/80 leading-relaxed mb-8" style={{ fontFamily: "'Ferom', Inter, sans-serif" }}>
                A Matilha é a camada de comunidade privada da{' '}<img src="/logo-sniffer-wordmark.png" alt="Sniffer" style={{ height: '1.05em', width: 'auto', display: 'inline', verticalAlign: 'middle', marginBottom: '0.12em', filter: 'brightness(0) invert(1)' }} />, um espaço onde o seu negócio cria círculos fechados e exclusivos com os clientes que mais importam. Diferente de um grupo de WhatsApp que vira caos em dois dias, a Matilha coloca você no controle absoluto: você decide quem entra, quem sai, e como o grupo se comporta. Cada Matilha funciona por convite, com aprovação do criador, regras visíveis desde o primeiro momento e até data de validade, se fizer sentido pro seu caso. É um ambiente íntimo, protegido e com identidade visual própria dentro da{' '}<img src="/logo-sniffer-wordmark.png" alt="Sniffer" style={{ height: '1.05em', width: 'auto', display: 'inline', verticalAlign: 'middle', marginBottom: '0.12em', filter: 'brightness(0) invert(1)' }} />{' '}— quando o cliente entra na sua Matilha, ele sabe que está num lugar diferente.
              </p>
          ...
          <div className="prose prose-invert max-w-none">
            <div className="my-12 p-8 rounded-2xl border border-white/10 bg-white/5 relative overflow-hidden group">
              ...
              <p className="text-[17px] text-white/80 leading-relaxed mb-6" style={{ fontFamily: "'Ferom', Inter, sans-serif" }}>
                O que torna a Matilha genuinamente diferente de qualquer grupo que existe hoje são os Rituais de Matilha, interações recorrentes e programadas que mantêm o grupo vivo sem você precisar carregar tudo nas costas. Você cria um ritual (uma pergunta semanal, um pedido de foto, um check-in rápido por emoji), define a frequência e o prazo de resposta, e a{' '}<img src="/logo-sniffer-wordmark.png" alt="Sniffer" style={{ height: '1.05em', width: 'auto', display: 'inline', verticalAlign: 'middle', marginBottom: '0.12em', filter: 'brightness(0) invert(1)' }} />{' '}entrega automaticamente para todos os membros.
              </p>
              <p className="text-[17px] text-white/80 leading-relaxed mb-6" style={{ fontFamily: "'Ferom', Inter, sans-serif" }}>
