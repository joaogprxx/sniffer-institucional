          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="flex flex-col lg:flex-row gap-16 items-start mb-12">
              ...
              <div className="flex-1">
                <p className="text-lg lg:text-[19px] text-white/80 leading-relaxed mb-8" style={{ fontFamily: "'Ferom', Inter, sans-serif" }}>
                  O Rastro é o programa de fundadores da{' '}<img src="/logo-sniffer-wordmark.png" alt="Sniffer" style={{ height: '1.05em', width: 'auto', display: 'inline', verticalAlign: 'middle', marginBottom: '0.12em', filter: 'brightness(0) invert(1)' }} />, e ele tem limite. São apenas 10.000 vagas para negócios em todo o Brasil. Quem entra agora garante 3 anos de acesso gratuito a todos os produtos da plataforma, incluindo tudo que for lançado nesse período. Sem mensalidade, sem cartão de crédito, sem surpresa.
                </p>
                <p className="text-lg lg:text-[19px] text-white/80 leading-relaxed" style={{ fontFamily: "'Ferom', Inter, sans-serif" }}>
                  Quando as 10.000 vagas acabarem, o programa fecha permanentemente, sem exceção, sem reabertura, sem lista de espera com promessa. Para participar, seu negócio precisa estar 100% ativo na{' '}<img src="/logo-sniffer-wordmark.png" alt="Sniffer" style={{ height: '1.05em', width: 'auto', display: 'inline', verticalAlign: 'middle', marginBottom: '0.12em', filter: 'brightness(0) invert(1)' }} />: perfil completo no Meu Território, Xodós escolhidos, primeira Matilha criada, Spotlight publicado, Uivo ativo, eventos cadastrados, Faro e Insights configurados. No momento em que tudo estiver completo, o relógio dos 3 anos começa a contar e o selo Rastro aparece no seu perfil pra sempre.
                </p>
              </div>
            ...
            <div className="my-12 p-8 rounded-2xl border border-white/10 bg-white/5 relative overflow-hidden group">
              ...
              <p className="text-[17px] text-white/80 leading-relaxed mb-6" style={{ fontFamily: "'Ferom', Inter, sans-serif" }}>
                E quando dizemos pra sempre, é pra sempre. O selo Rastro é permanente, ele aparece no seu perfil, nos resultados de busca, no mapa, no feed, em toda a superfície da{' '}<img src="/logo-sniffer-wordmark.png" alt="Sniffer" style={{ height: '1.05em', width: 'auto', display: 'inline', verticalAlign: 'middle', marginBottom: '0.12em', filter: 'brightness(0) invert(1)' }} />{' '}onde seu negócio for visto. Mas o mais poderoso acontece fora do app: cada negócio fundador recebe um adesivo físico e um quadro emoldurado com o selo Rastro e um QR code que leva direto pro seu perfil. Quando alguém entra no seu estabelecimento e vê a pata verde na parede, a pergunta é automática: "o que é isso?", e aí começa uma conversa que nenhum anúncio pago consegue comprar.
              </p>
